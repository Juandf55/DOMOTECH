...
public class DatabaseConnection {
    ...
    private static final String USER = "db_JFrutos";
    private static final String PASSWORD = "22301876"; // Pon tu contraseña si tiene
    ...
    public Vector<String> obtenerMensajesPorGrupo(int idUsuario) {
        ...
        String sql = "SELECT m.mensaje, m.fecha, u.nombre " +
                ...
                "WHERE u.id_Grupo = (SELECT id_Grupo FROM usuario WHERE id_Usuario = ?) " +
        ...
        try (Connection conn = getConnection();
            ...
            while (rs.next()) {
                ...
                mensajes.add("[" + fecha + "] " + autor + ": " + mensaje);
            }
